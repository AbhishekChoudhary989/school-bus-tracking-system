...
if (isset($_POST['submit'])) {
 ...
 $query="select * from add_driver where Driver_Name='$name' and Bus_No='$bnum' ";
 ...
 $count=mysqli_num_rows($result);
   if($count>0)
   {
      ...
      switch ($bnum) 
      {
        case '301':
          ...
          break;
        case '302':
          header("location:markatt2.php");
          exit();
          break;
        
        default:
           imap_alerts("Write correct bus number");
          exit();
          break;
      }
   }
   ...
   {
     $error =  "** Incorrect Name or Bus number";
   }
}
?>
<!DOCTYPE html>
      ...
      <form action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="POST" onsubmit="return valide()">
        <div class="error"><?php echo $error ?></div>
            ...
            <div class="form-group input-group" id="input">
              ...
              <input type="text" name="name" class="form-control" placeholder="Enter your name" autocomplete="of" required>
            </div>
            <span id="username"></span><br>
             ...
             <div class="form-group input-group" id="input">
              ...
              <input type="text" name="busno" class="form-control" placeholder="Enter Bus No." autocomplete="of" required>
            </div>
