...
<head>
  ...
  <title>Track Location page hindi</title>
...
<body>
  ...
  <p id="heads" style="">स्कूल बस ट्रैकिंग प्रणाली</p>
 </div>
</div>
  <fieldset>
  <div class="card" id="cont" style="background-color:#f4f4f6; padding:10px; margin: 5% 25% 0% 25%; border: 1px solid black; width:50%">
    <article class="card-body mx-auto" style="//max-width: 1000px;">
      <h1 class="card-title mt-3 text-center">ट्रैक स्थान</h1><br>
      <form action="#" method="POST" onsubmit="return valide()">
        <div class="error"><?php echo $error ?></div>
            ...
            <div class="form-group input-group" id="input">
              ...
              <input type="text" name="name" class="form-control" placeholder="अपना छात्र का नाम दर्ज करें" autocomplete="off" required>
            </div>
            ...
            <div class="form-group">
              <button type="submit" name="submit" value="SUBMIT" class="btn btn-primary btn-block">जमा करें</button>
            </div>
            </form>
    </article> 
    </div>
