...
<div class="login">
  ...
  <p id="heads" style="text-align: center; margin-top: -90px;padding: 5px; font-size: 50px;font-family:'Righteous', cursive;">स्कूल बस ट्रैकिंग प्रणाली</p></div>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
     <ul class="navbar-nav navbar-right">
      <li class="nav-item"><a class="nav-link" href="P2LogHindi.html"><span class="glyphicon glyphicon-log-in"></span> निकासी</a></li>
    </ul>
 </div>
</nav>
</div>
...
हम जानना चाहते हैं कि हमने कैसा प्रदर्शन किया। कृपया हमें अपनी मूल्यवान प्रतिक्रिया देने के लिए कुछ क्षण ों को छोड़ दें क्योंकि यह हमारी सेवा में सुधार करने में हमारी मदद करेगा </p>
<div class="driver_data">
    <form action="#" method="POST" onsubmit="return valide()" enctype="multipart/form-data">
         <div class="error"> <?php echo $error ?></div>
        
        <label>ड्राइवर का नाम :</label>
            <div class="form-group input-group" id="input">
              <div class="input-group-prepend">
                <span class="input-group-text"><i class="fa fa-user"></i></span>
              </div>
            <input type="text" name="driname" class="form-control" placeholder="अपना नाम दर्ज करें" autocomplete="off" required>
            </div>
            <span id="username"></span>
             ...
             <div class="form-group input-group" id="input">
              ...
              <input type="text" name="busno" class="form-control" placeholder="बस नंबर दर्ज करें" autocomplete="off" required>
            </div>
             <span id="trkltn">&nbsp&nbsp</span>
             
<br>
</div>
<h4>कृपया निम्न पैरामीटर्स के लिए अपने सेवा अनुभव को रेट करें</h4>

<form method="post" action="#action-url">
<label>1.हमारे साथ आपका समग्र अनुभव ?</label><br>
...
<span class="star-rating">
  ...
  <div class="clear"></div> 
  <hr class="survey-hr">
<label>2. ड्राइवर कितना कुशल है?</label><br>
<span class="star-rating">
  ...
  <div class="clear"></div> 
  <hr class="survey-hr">
<label>3.आपके बच्चे ड्राइवर द्वारा सुरक्षा कितना महसूस करते हैं?</label><br><br/>
  <div style="color:grey">
    <span style="float:left">ख़राब</span>
...
<span class="scale-rating">
  ...
  <div class="clear"></div> 
  <hr class="survey-hr"> 
<label for="m_3189847521540640526commentText">4.कोई अन्य सुझाव:</label><br/><br/>
<textarea cols="75" name="commentText" rows="5" style="100%"></textarea><br>
<br>
  <div class="clear"></div> 
<input style="background:#43a7d5;color:#fff;padding:12px;border:0" type="submit"  name="submit" value="अपनी समीक्षा सबमिट करें">&nbsp;
</form>
                  </div>
