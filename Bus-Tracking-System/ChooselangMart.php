...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
  <meta charset="utf-8">
  <title>Update Student Language Marathi</title>
...
<body>
  ...
  <p id="heads" style="text-align: center; margin-top: -100px;padding: 5px; font-size: 50px; font-family: 'Chakra Petch', sans-serif;">स्कूल बस ट्रॅकिंग सिस्टम</p>
...
<fieldset>
  <div class="card" id="cont" style="background-color:#f4f4f6; padding:10px; margin: 5% 25% 0% 25%; border: 1px solid black; width:50%">
    <article class="card-body mx-auto" style="max-width: 1000px;">
       <h2 class="card-title mt-3 text-center">भाषा निवडा</h2>
       <div class="container">
       <form action="" method="GET">
            <label>विद्यार्थ्यांचे नाव :</label>
            <div class="form-group input-group" id="input">
              <div class="input-group-prepend"><span class="input-group-text"><i class="fa fa-user"></i></span></div>
              <input type="text" name="stname" value="<?php echo "$stdname" ?>" class="form-control" placeholder="विद्यार्थ्यांचे नाव प्रविष्ट करा" autocomplete="off" required>
            </div>

            <label>भाषा निवडा :</label>
            <div class="form-group input-group" id="input">
              <div class="input-group-prepend">
              <div class="form-check">
                <input type="radio" class="form-check-input" id="radio1" name="optradio" value="English" checked>अंग्रेज़ी&nbsp&nbsp&nbsp
                <label class="form-check-label" for="radio1"></label>
               </div>
               <div class="form-check">
                 <input type="radio" class="form-check-input" id="radio2" name="optradio" value="Hindi">हिंदी&nbsp&nbsp&nbsp
                 <label class="form-check-label" for="radio2"></label>
               </div>
               <div class="form-check">
                  <input type="radio" class="form-check-input" id="radio3" name="optradio" value="Marathi">मराठी
                  <label class="form-check-label" for="radio2"></label>
               </div>
            </div>
           </div>
            ...
            <div class="form-group">
              <button type="submit" name="submit" value="SELECT LANGUAGE" class="btn btn-primary btn-block">प्रस्तुत करा</button>
            </div>
        </form>
        </div>
    </article>
