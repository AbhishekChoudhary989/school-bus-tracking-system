...
.border {border-radius:10%; background-color:#AEC6CF; width: 300px;height:55%; border: 2px solid black; padding: 50px;margin-top: 100px; display: block; margin-left:500px; padding: 10px 25px; /* Some padding */ cursor: pointer;}
.login{ background:white;}
#name{ margin-top:-100px; margin-left:110px; font-size:20px;color:white;}
...
<button class="present" >CLOSE</button>
  </div>
  </div>
